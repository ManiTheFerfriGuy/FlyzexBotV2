...
PERSIAN_TEXTS = TextPack(
    dm_welcome=(
        "<b>🪟 سلام! خوشحالیم به بات فلایزکس سر زدی.</b>\n\n"
    ...
    group_panel_admins_hint="برای مدیریت ادمین‌ها از پنل خصوصی بات استفاده کن.",
    ...
    group_help_admin_hint="دستورات زیر نیاز به دسترسی ادمین دارند. برای مدیریت ادمین‌ها از پیام خصوصی بات استفاده کن.",
...
ENGLISH_TEXTS = TextPack(
    ...
    group_panel_admins_hint="Use the bot's DM admin panel to adjust admin roles.",
    ...
    group_help_admin_hint="You need admin rights to run the commands below. To manage admins, use the bot's DM panel.",
